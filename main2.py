...
arcade.draw_ellipse_filled(face_x + 30, face_y + 25, 20, 30, open_color.black)
arcade.draw_ellipse_filled(face_x + -30, face_y + 25, 20, 30, open_color.black)
arcade.draw_circle_filled(face_x + 32, face_y + 32, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + -28, face_y + 32, 3, open_color.gray_2)

#(x,y,width,height,color,start_degrees,end_degrees,border_thickness)
arcade.draw_arc_outline(face_x + 0, face_y + -3, 60, 50, open_color.black, 190, 350, 4)
